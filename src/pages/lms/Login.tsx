    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <a href="/">
            <img src="/nobzlearn-logo.png" alt="NobzLearn" className="h-12 w-auto mx-auto mb-4" />
          </a>
        ...
        <div className="bg-card rounded-2xl shadow-card border border-border p-8">
          ...
          {/* Google OAuth — only shown on signin/signup */}
          {mode !== 'forgot' && (
            <div className="mb-6">
              <button
                type="button"
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-border bg-background hover:bg-secondary transition-colors font-semibold text-sm text-foreground disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {googleLoading ? (

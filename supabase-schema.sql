...
('UI/UX Design Fundamentals', 'Learn the principles of good design', 'Design', 'beginner', 39.99, '6 hours'),
('Node.js Backend Development', 'Build scalable backend applications', 'Backend', 'intermediate', 69.99, '10 hours'),
('Python for Data Science', 'Analyze data with Python', 'Data Science', 'intermediate', 89.99, '12 hours');